...
// Backend-ul de referință de la Lecția 1.
export const DEFAULT_API_BASE = "http://localhost:8080";
export const PRACTICE_PATH = "/api/practice";
...
//   shows: []         = ce secțiuni ale magazinului sunt vizibile la acea lecție.
//                       Chei posibile: "catalog", "admin", "cart".
...
export const LESSONS = [
  ...
  { id: 2, title: "Lecția 2 — Baze de date & JWT", available: false, shows: ["catalog"] },
  { id: 3, title: "Lecția 3 — Redis, Swagger, Git", available: false, shows: ["catalog", "admin", "cart"] },
];
